...
class SettingPage(SiPage):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.system_startup_card.load('uiprofile/components/setting_page/computer.svg')

        # 开启最小化
        self.startup_minimize_card = SettingLinerCard(self)
        self.startup_minimize_card.setTitle("启动最小化", "->任务托盘")
        self.startup_minimize_card.load('uiprofile/components/setting_page/angle-small-down.svg')
        ...
        self.enable_fan_control_card.load('uiprofile/components/setting_page/AWCC.svg')
