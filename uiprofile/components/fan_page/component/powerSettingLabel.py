...
from SDK import globalConfig, checkGCfg, powerCount, powerCfgs, setPower, saveConfig,getPower
...
class PowerSettinglabel(SiOptionCardLinear):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # 加载保存选项
        self.power_list.menu().setIndex(getPower())
    ...
    def power_plan_on_change(self, index):
        print(f"power value changed{index}")
        setPower(index)
